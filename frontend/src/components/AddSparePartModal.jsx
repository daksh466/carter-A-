...
export default function AddSparePartModal({ isOpen, onClose, onSuccess }) {
  ...
  const labelClass = 'mb-1.5 block text-xs font-semibold tracking-wide text-gray-700 dark:text-slate-300';
  const inputClass =
    'w-full rounded-lg border border-gray-300 bg-white px-3 py-2.5 text-gray-900 placeholder-gray-500 transition-colors duration-300 focus:border-cyan-500 focus:outline-none dark:border-slate-700 dark:bg-slate-900/85 dark:text-slate-100 dark:placeholder-slate-500 dark:focus:border-cyan-400';
  const sectionCardClass = 'rounded-xl border border-gray-200 bg-white p-4 transition-colors duration-300 dark:border-slate-700/80 dark:bg-slate-900/55';
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 px-4 py-6 backdrop-blur-sm">
      <div className="w-full max-w-3xl overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-2xl transition-colors duration-300 dark:border-slate-700 dark:bg-slate-950 dark:shadow-[0_30px_100px_rgba(8,47,73,0.55)]">
        <div className="border-b border-gray-200 bg-gradient-to-r from-cyan-100 via-white to-amber-100 px-6 py-5 transition-colors duration-300 dark:border-slate-700 dark:from-cyan-900/35 dark:via-slate-900 dark:to-amber-900/25">
          <div className="flex items-start justify-between gap-4">
            <div>
              <h2 className="text-2xl font-extrabold tracking-tight text-slate-900 dark:text-slate-100">Add New Spare Part</h2>
            ...
            <button
              type="button"
              onClick={onClose}
              className="rounded-lg border border-gray-300 bg-white px-3 py-1.5 text-xs font-semibold text-gray-700 transition hover:border-gray-400 hover:bg-gray-100 dark:border-slate-600 dark:bg-slate-800 dark:text-slate-200 dark:hover:border-slate-400 dark:hover:bg-slate-700"
            >
              Close
            </button>
          </div>
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            <span className="rounded-full border border-cyan-400/50 bg-cyan-100 px-3 py-1 text-xs font-semibold text-cyan-800 dark:border-cyan-400/35 dark:bg-cyan-400/15 dark:text-cyan-200">
              Required: Name, Size, Machine, Store, Quantity, Min Required
            </span>
            <span className="rounded-full border border-emerald-400/50 bg-emerald-100 px-3 py-1 text-xs font-semibold text-emerald-800 dark:border-emerald-400/35 dark:bg-emerald-400/15 dark:text-emerald-200">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <section className={sectionCardClass}>
              <div className="mb-3 flex items-center gap-2">
                <span className="rounded-md bg-cyan-100 px-2 py-1 text-[11px] font-bold uppercase tracking-wider text-cyan-800 dark:bg-cyan-900/40 dark:text-cyan-200">Step 1</span>
                <h3 className="text-sm font-bold text-slate-800 dark:text-slate-200">Part Identity</h3>
              </div>
            ...
            <section className={sectionCardClass}>
              <div className="mb-3 flex items-center gap-2">
                <span className="rounded-md bg-emerald-100 px-2 py-1 text-[11px] font-bold uppercase tracking-wider text-emerald-800 dark:bg-emerald-900/40 dark:text-emerald-200">Step 2</span>
                <h3 className="text-sm font-bold text-slate-800 dark:text-slate-200">Location and Stock</h3>
              </div>
              <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
                <div>
            ...
            <section className={sectionCardClass}>
              <div className="mb-3 flex items-center gap-2">
                <span className="rounded-md bg-amber-100 px-2 py-1 text-[11px] font-bold uppercase tracking-wider text-amber-800 dark:bg-amber-900/40 dark:text-amber-200">Step 3</span>
                <h3 className="text-sm font-bold text-slate-800 dark:text-slate-200">Warranty and Lot Details (Optional)</h3>
              </div>
              <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
                <div>
