            ...
            <div className="flex h-full flex-col">
              <div className="border-b border-gray-200 bg-white/80 px-6 py-5 backdrop-blur transition-colors duration-300 dark:border-sky-200/15 dark:bg-slate-950/35">
                <div className="flex items-start justify-between gap-4">
                  <div>
                    <h2 className="text-2xl font-extrabold tracking-tight text-slate-900 dark:text-white">Outgoing Shipment</h2>
                    <p className="mt-1 text-sm text-slate-600 dark:text-slate-300">Dispatch inventory and track it as in transit.</p>
                  </div>
                  <button
                    type="button"
                    onClick={onClose}
