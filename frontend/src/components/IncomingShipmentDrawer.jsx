            ...
            <div className="flex h-full flex-col">
              <div className="border-b border-sky-200/15 bg-slate-950/35 px-6 py-5 backdrop-blur">
                <div className="flex items-start justify-between gap-4">
                  <div>
                    <h2 className="text-2xl font-extrabold tracking-tight text-white">Incoming Shipment</h2>
                    <p className="mt-1 text-sm text-slate-300">Create and track incoming stock movement.</p>
                  </div>
                  <button
                    type="button"
                    onClick={onClose}
